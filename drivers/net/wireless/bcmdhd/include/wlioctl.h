...
/* Maximm packet filter size that can be set and cached */
#define MAX_WAKE_PACKET_BYTES 128

/* Cached packet that matches any of the enabled pkt filter pattern */
...
typedef enum wl_pkt_filter_type {
	...
	WL_PKT_FILTER_TYPE_MAGIC_PATTERN_MATCH	/* Magic packet match */
