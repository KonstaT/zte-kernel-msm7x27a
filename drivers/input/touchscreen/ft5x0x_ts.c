...
//#if defined(CONFIG_TOUCHSCREEN_FOCALTECH_FW) ||defined(CONFIG_TOUCHSCREEN_FOCALTECH_USBNOTIFY)
//static struct i2c_client *update_client;
...
#elif defined (CONFIG_MACH_ATLAS40)//P740A  800*480       MENU HOME BACK SEARCH  temp
           ...
           unsigned long count, void *data)
{
	...
	if ( Ft5x0x_fwupdate(update_client) < 0 ){
