...
#define CTPM_FW_NAME "Ver11_20120314_040_9980_ID0x57_app_atlas40.bin"
#endif
						...
						const char *buf, size_t count)
{
	...
	ret = fts_ctpm_write_fw_with_app_file(client, fwname);
...
{
	char crtFwVendorId;//current fw vendor id
